<template>
    <body class="body_form">
        <h1 class="h1_form text-center">Thông tin sản phẩm</h1>
        <form @submit.prevent="save()" class="product_form">
            <fieldset class="fieldset_form">
                <label class="font-weight-bold">Nhập tên sản phẩm:
            ...
            <input class="btn btn-primary d-flex justify-content-center w-100" type="submit" value="Submit" />
            <hr>
            <p class="font-weight-bold d-flex align-items-center justify-content-center">OR</p>
            <button class="btn btn-success d-flex justify-content-center w-100" @click="back_product_manager">Trở về</button>
        </form>
    </body>
</template>
<script>
