        ...
        <div class="container py-5">
            <div class="row d-flex justify-content-center my-4">
                <div class="col-md-8">
                    ...
                    <div class="card mb-4 border border-1 rounded border-secondary">
                        <div class="card-header border border-secondary bg-info py-3">
                            <h5 class="mb-0 text-center text-white">Sản phẩm</h5>
                        </div>
                        <div class="card-body border border-secondary" :key="index" v-for="(product, index) in products">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 mb-4 mb-lg-0 text-center">
                                    <!-- Data -->
                                    <p><strong>{{ product.name }}</strong></p>
                                    <!-- Data -->
                                </div>
                                <div class="col-sm-8 mb-4 mb-lg-0 row d-flex justify-content-center">
                                    <!-- Quantity -->
                                    <div class="d-flex col-sm-7" style="max-width: 200px;">
                                        ...
                                        <div class="form-outline">
                                            <input id="form1" min="0" name="quantity" v-model="product.quantity"
                                                type="number" class="form-control text-center" @change="updateQuantity(product)" />
                                            <label class="form-label text-center" for="form1">Số lượng</label>
                                        </div>
                                    ...
                                    <div class="checkbox-container col-sm-1 d-flex justify-content-center mb-2 mt-2 align-items-baseline">
                                        <input type="checkbox" v-model="product.isSelected"
                                            @click="handleCheckboxClick(product)">
                                    </div>
                                    <button type="button" class="btn btn-danger col-sm-1 smaller-icon" data-mdb-toggle="tooltip"
                ...
                <div class="col-md-4">
                    <div class="card mb-4 border border-1 rounded border-secondary">
                        <div class="card-header border border-secondary bg-info py-3">
                            <h5 class="mb-0 text-center text-white">Summary</h5>
                        </div>
